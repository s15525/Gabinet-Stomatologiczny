...
public class Main {
    public static void main(String[] arg) {
        ...
        //atrybut powtarzalny
        Klient marek = new Klient("Marek", "Piekarczuk", "13.08.1997", "972394234324", new ArrayList<>() {{
            add("787888787");
        }});
        System.out.println();
        ...
        //Przysloniecie metod
        Osoba pawel = new Klient("Marek", "Piekarczuk", "13.08.1997", "972394234324", new ArrayList<>() {{
            add("787888787");
        }});
        Osoba krystian = new Klient("Marek", "Piekarczuk", "13.08.1997", "972394234324", new ArrayList<>() {{
            add("787888787");
        }});
